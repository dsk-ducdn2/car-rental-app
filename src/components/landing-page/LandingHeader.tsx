  ...
  return (
    <header class="w-full px-4 sm:px-6 md:px-8 py-4 md:py-6 flex items-center bg-white shadow-sm sticky top-0 z-20">
      ...
      <nav class="hidden md:flex gap-10 text-base font-medium flex-1 items-center justify-center">
        ...
        <a href="#popular-deals" class="hover:text-[#2563eb] transition">Popular Rental Deals</a>
        <a href="#testimonials" class="hover:text-[#2563eb] transition">Testimonials</a>
        <a href="#contact-sales-section" class="ml-4 px-7 py-2 rounded-full font-semibold text-white bg-gradient-to-r from-[#2d6fa3] to-[#23b6a0] flex items-center gap-2 shadow hover:opacity-90 transition border-0" style={{minWidth:'160px', justifyContent:'center', height:'44px'}}>
          Registration Form
      ...
      {open.value && (
        <div class="absolute top-full left-0 w-full bg-white shadow-lg flex flex-col items-center py-4 gap-4 md:hidden animate-fade-in z-30">
          ...
          <a href="#popular-deals" class="text-base font-medium hover:text-[#2563eb] transition">Popular Rental Deals</a>
          <a href="#testimonials" class="text-base font-medium hover:text-[#2563eb] transition">Testimonials</a>
          <a href="#contact-sales-section" class="mt-2 px-7 py-2 rounded-full font-semibold text-white bg-gradient-to-r from-[#2d6fa3] to-[#23b6a0] flex items-center gap-2 shadow hover:opacity-90 transition border-0" style={{minWidth:'160px', justifyContent:'center'}}>
            Registration Form
            <svg width="22" height="22" fill="none" viewBox="0 0 22 22"><path d="M7 11h8m0 0-3-3m3 3-3 3" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </a>
        </div>
