...
export const DashboardStatsOverview = component$(() => {
  ...
  return (
    <div class="flex flex-col md:flex-row gap-2 md:gap-6 mt-8">
      {/* Card trái */}
      <div class="bg-white rounded-2xl shadow p-4 md:p-8 flex-1 min-w-full md:min-w-[400px] flex flex-col justify-between mb-2 md:mb-0">
        <div>
          <div class="text-lg font-bold mb-2">Active Users</div>
          <div class="text-blue-600 font-semibold text-sm mb-6">
            (+23%) <span class="text-gray-400 font-normal">THAN LAST WEEK</span>
          </div>
        </div>
        <div class="flex flex-col sm:flex-row gap-4 md:gap-8 items-end">
          {/* Users */}
          <div>
            <div class="flex items-center gap-2 mb-1">
              <span class="bg-pink-500 rounded p-1">
                {/* User icon */}
            ...
            <div class="text-2xl font-bold">36K</div>
          ...
          <div>
            <div class="flex items-center gap-2 mb-1">
              <span class="bg-orange-400 rounded p-1">
                {/* Sales icon */}
            ...
            <div class="text-2xl font-bold">$435</div>
            <div class="h-1 bg-cyan-400 rounded mt-1 w-16"></div>
          </div>
          {/* Items */}
          <div>
      ...
      {/* Card phải: Chart */}
      <div class="bg-white rounded-2xl shadow p-4 md:p-8 flex-1 min-w-full md:min-w-[400px]">
