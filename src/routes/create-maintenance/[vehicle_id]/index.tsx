      ...
      <main class="flex-1 w-full flex flex-col min-h-screen pb-16">
        ...
        <div class="px-2 sm:px-4 md:px-8">
          <div class="bg-white rounded shadow p-6 max-w-5xl mx-auto">
            <h2 class="text-xl font-bold mb-6 text-center">Create Maintenance Schedule</h2>
            {loadingVehicle.value ? (
              ...
              <div class="space-y-6">
                <div>
                  ...
                  <div class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 flex items-center gap-2">
                    <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 13l2-2m0 0l7-7 7 7M5 11v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    <span class="text-sm text-gray-700">Vehicle: {vehicle.value.brand} {vehicle.value.licensePlate}</span>
                  </div>
                </div>
