...
export interface Vehicle {
  ...
  rentCount: number;
  maintenance: {
    cycleKm: number; // chu kỳ km
    cycleMonths: number; // chu kỳ tháng
...
export const mockVehicles: Vehicle[] = [
  {
    ...
    flexiblePrice: { weekday: 700000, weekend: 900000, holiday: 1200000 },
    companyId: 1,
  },
  {
    id: 2,
    ...
    flexiblePrice: { weekday: 900000, weekend: 1100000, holiday: 1500000 },
    companyId: 1,
  },
  {
    id: 3,
    image: 'https://cdn.pixabay.com/photo/2013/07/12/15/55/car-150334_1280.png',
    type: 'Hatchback',
    licensePlate: '51C-24680',
    km: 21000,
    brand: 'Kia',
    year: 2020,
    price: { hour: 90000, day: 600000, month: 12000000 },
    seats: 5,
    status: 'Reserved',
    rating: 4.3,
    rentCount: 18,
    maintenance: {
      cycleKm: 5000,
      cycleMonths: 6,
      lastMaintenanceKm: 16000,
      lastMaintenanceDate: '2024-03-10',
    },
    flexiblePrice: { weekday: 600000, weekend: 800000, holiday: 1000000 },
    companyId: 2,
  },
  {
    id: 4,
    ...
    type: 'Convertible',
    licensePlate: '43D-13579',
    km: 12000,
    brand: 'Mazda',
    year: 2021,
    price: { hour: 200000, day: 1200000, month: 25000000 },
    seats: 4,
    status: 'Available',
    rating: 4.8,
    rentCount: 40,
    ...
    flexiblePrice: { weekday: 1200000, weekend: 1500000, holiday: 2000000 },
    companyId: 2,
  },
]; 